...
def compare_xml_with_prompt(tablet_xml_str, phone_xml_str):
...
def main(tablet_path, phone_path, output_path='validation_result.json'):
    ...
    print("Tablet XML snippet: >>>", repr(tablet_xml_str[:300]), "<<<")
    print("Phone XML snippet: >>>", repr(phone_xml_str[:300]), "<<<")
    result = compare_xml_with_prompt(tablet_xml_str, phone_xml_str)
...
if __name__ == "__main__":
    ...
    phone_xml_path = "/Users/game/Desktop/chi/auto_app_update/xml_compare/xml_file/window_dump_3.xml"
