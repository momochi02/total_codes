...
def compare_nodes(t_nodes, p_nodes,prompt_txt_str):
...
def compare_xml_by_gauss(tablet_xml_str, phone_xml_str, prompt_txt_str=""):
    print("Tablet XML snippet: >>>", repr(tablet_xml_str[:300]), "<<<")
    print("Phone XML snippet: >>>", repr(phone_xml_str[:300]), "<<<")
    print("prompt_txt_str: >>>", repr(prompt_txt_str[:300]), "<<<")
    try:
    ...
    discrepancies = compare_nodes(t_nodes, p_nodes,prompt_txt_str)
    result = {
...
def main(tablet_path, phone_path, prompt_txt,output_path='validation_result.json'):
    ...
    print("Tablet XML snippet: >>>", repr(tablet_xml_str[:300]), "<<<")
    print("Phone XML snippet: >>>", repr(phone_xml_str[:300]), "<<<")
    result = compare_xml_by_gauss(tablet_xml_str, phone_xml_str,prompt_txt_str)
...
#     prompt_txt ="/Users/game/Desktop/chi/auto_app_update/backend_proxy_api/xml_compare/prompt/promt_v6.txt"
...
#     main(tablet_xml_path, phone_xml_path,prompt_txt)
